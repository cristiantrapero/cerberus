...
(new-statement {ClipService-service-instance}  {performs action through} {capture_audio}
	       :c {ClipService.notify})
(new-type {recorded audio} {event})
(new-statement {capture_audio} {causes} {recorded audio})
(new-statement {ClipService-service-instance} {causes event through} {recorded audio}

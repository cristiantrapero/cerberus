...
(new-statement {PersonRecognizer-service-instance}  {performs action through} {recognize_person} :c {PersonRecognizer.trigger})

(new-statement {recognize_person} {causes} {person recognition})
(new-statement {PersonRecognizer-service-instance} {causes event through} {person recognition} :c {AuthenticatedCommandService.notifyPerson})

...
(new-statement {SnapshotService-service-instance}  {performs action through} {take_snapshot} :c {SnapshotService.notify})

(new-type {scene snapshoted} {event})
(new-statement {take_snapshot} {causes} {scene snapshoted})
(new-statement {SnapshotService-service-instance} {causes event through} {scene snapshoted} :c {DataSink.trigger})

...
(new-statement {Authenticator-service-instance}  {performs action through} {execute_authorised_command}
	       :c {Authenticator.notifyCommand})
(new-statement {execute_authorised_command} {causes} {command execution by authorised person})
(new-statement {Authenticator-service-instance} {causes event through}
	       {command execution by authorised person}
